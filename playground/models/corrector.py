...
def main(analyzer_dir) -> None:
    ...
    A decade ago, France was primarily seen as a land of traditional industries, often perceived as being slowed by bureaucracy. Today, the landscape has radically shifted. From Paris to Lyon, and Montpellier to Lille, the startup ecosystem—united under the 'La French Tech' label—has become one of the most dynamic in Europe.
    ### A Supported and Structured Ecosystem
    The success of French startups is no accident. It is built on strong political will and unique public support, notably through Bpifrance. This public investment bank acts as a catalyst by financing innovation and de-risking investments for private players.
    ...
    France hit its government-mandated target two years early: surpassing 25 unicorns (unquoted companies valued at over $1 billion). Names like Back Market, Doctolib, ManoMano, and ContentSquare have become leaders in their respective sectors.
    However, beyond mere valuation, the focus is shifting toward profitability and impact. We are seeing the rise of GreenTech and decarbonized industrial startups, directly addressing current climate challenges.
    ### New Frontiers: AI and Sovereignty
    Artificial Intelligence (AI) is the new battlefield. With champions like Mistral AI, France is proving it can compete with American and Chinese giants. The stakes are twofold: attracting international talent and ensuring European technological sovereignty.
    ...
    * Diversity and Parity: Women remain underrepresented among startup founders, representing a significant untapped growth lever.
    ...
    prompt = (
        ...
        "- Output should start with OUTPUT.\n"
        "- Output should end with a point.\n"
        "- Make it simple and keep original tone.\n\n"
        "QUERY: " + user_draft
    )
    completion_request = ChatCompletionRequest(
        messages=[
